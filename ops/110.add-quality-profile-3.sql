-- @operation: export
-- @entity: batch
-- @name: Add quality profile 1080p Quality HDR - MULTi VFF
-- @exportedAt: 2026-08-17T09:27:10.000Z
-- @opIds: 110

-- --- BEGIN op 110 ( Add quality profile 1080p Quality HDR - MULTi VFF )
INSERT INTO "quality_profiles" ("name", "description", "upgrades_allowed", "minimum_custom_format_score", "upgrade_until_score", "upgrade_score_increment") VALUES ('1080p Quality HDR - MULTi VFF', '', 0, 10000, 0, 1);
INSERT INTO "quality_profile_qualities" ("quality_profile_name", "quality_name", "position", "enabled", "upgrade_until") VALUES ('1080p Quality HDR - MULTi VFF', 'WEBDL-1080p', 1, 1, 0);
INSERT INTO "quality_profile_qualities" ("quality_profile_name", "quality_name", "position", "enabled", "upgrade_until") VALUES ('1080p Quality HDR - MULTi VFF', 'Bluray-1080p', 2, 1, 0);
