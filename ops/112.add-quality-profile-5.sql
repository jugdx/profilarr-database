...
INSERT INTO "quality_profiles" ("name", "description", "upgrades_allowed", "minimum_custom_format_score", "upgrade_until_score", "upgrade_score_increment") VALUES ('2160p Efficient - MULTi VFF', '', 0, 10000, 0, 1);
INSERT INTO "quality_profile_qualities" ("quality_profile_name", "quality_name", "position", "enabled", "upgrade_until") VALUES ('2160p Efficient - MULTi VFF', 'WEBDL-2160p', 1, 1, 0);
INSERT INTO "quality_profile_qualities" ("quality_profile_name", "quality_name", "position", "enabled", "upgrade_until") VALUES ('2160p Efficient - MULTi VFF', 'Bluray-2160p', 2, 1, 0);
