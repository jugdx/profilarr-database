...
INSERT INTO "regular_expressions" ("name", "pattern", "description") VALUES ('REG_fr-vf-mono', '(?i)\b(FRENCH|VF|VFF|TRUEFRENCH|VF2|VOF|VOFR)\b(?!.*\b(MULTI|DUAL)\b)', '');
INSERT INTO "custom_formats" ("name", "description") VALUES ('FR - VF Mono', 'French track only (without MULTi).');
