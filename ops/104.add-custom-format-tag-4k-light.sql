...
INSERT INTO "regular_expressions" ("name", "pattern", "description") VALUES ('REG_tag-4k-light', '(?i)\b(4K[\.\-_ ]?Light|UHD[\.\-_ ]?Light|Light)\b', '');
INSERT INTO "custom_formats" ("name", "description") VALUES ('Tag - 4K Light / Light', 'Explicit Light tag.');
