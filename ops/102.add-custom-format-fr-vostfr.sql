...
INSERT INTO "regular_expressions" ("name", "pattern", "description") VALUES ('REG_fr-vostfr', '(?i)\b(VOST(\.|\-)?FR|SUB\.?FRENCH|STFR)\b', '');
INSERT INTO "custom_formats" ("name", "description") VALUES ('FR - VOSTFR', 'Embedded or included French subtitles.');
